...
export GCC_COLORS
BASE_CPPFLAGS='-U__USE_MINGW_ANSI_STDIO -D__USE_MINGW_ANSI_STDIO=1 -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -U__MINGW_USE_VC2005_COMPAT -D__MINGW_USE_VC2005_COMPAT=1 -U_FILE_OFFSET_BITS -D_FILE_OFFSET_BITS=64 -UWINVER -DWINVER=0x0601 -U_WIN32_WINNT -D_WIN32_WINNT=0x0601 -U_GNU_SOURCE -D_GNU_SOURCE=1 -U_BSD_SOURCE -D_BSD_SOURCE=1 -U_POSIX_SOURCE -D_POSIX_SOURCE=1 -U_POSIX_C_SOURCE -D_POSIX_C_SOURCE=200809L -U_XOPEN_SOURCE -D_XOPEN_SOURCE=700'
...
BASE_LDFLAGS='-Wl,-s,-O1,--sort-common,--as-needed,--no-undefined,--gc-sections -mcrtdll=msvcr120'
