...
export GCC_COLORS
BASE_CFLAGS="-pipe -Os -foptimize-strlen -mfpmath=sse -msse4 -fexcess-precision=fast -fstack-protector-strong --param=ssp-buffer-size=4 -fno-fast-math -fno-tree-vectorize"
